...
store <-read.csv("/cloud/project/DEPARTMENTAL STORE PROJECT/MY FINAL DEPARTMENTAL STORE.csv")
View(store)

#7.1.PLOT FOR AVERAGE_QUANTITY & PRODUCT_TYPE
...
#7.2.PLOT FOR AVERAGE_NET_PROFIT & PRODUCT_TYPE
store %>% group_by(PRODUCT_TYPE) %>%
