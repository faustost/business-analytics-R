...
store <- read.csv("/cloud/project/DEPARTMENTAL STORE PROJECT/MY DEPARTMENTAL STORE.csvMY DEPARTMENTAL STORE.csv")
View(store)
...
write.table(store3, file = "/cloud/project/DEPARTMENTAL STORE PROJECT/FINAL DEPARTMENTAL STORE.csv", sep=",")
